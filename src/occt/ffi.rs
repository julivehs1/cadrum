...
mod ffi_bridge {
	...
	unsafe extern "C++" {
		...
		fn builder_thick_solid(solid: &TopoDS_Shape, open_faces: &CxxVector<TopoDS_Face>, thickness: f64, out_history: &mut Vec<u64>, out_edge_history: &mut Vec<u64>, out_gen_faces: &mut Vec<u64>) -> UniquePtr<TopoDS_Shape>;
		...
		fn make_extrude(profile_edges: &CxxVector<TopoDS_Edge>, dx: f64, dy: f64, dz: f64, out_gen_faces: &mut Vec<u64>, out_gen_edges: &mut Vec<u64>) -> UniquePtr<TopoDS_Shape>;
		fn make_revolve(profile_edges: &CxxVector<TopoDS_Edge>, ox: f64, oy: f64, oz: f64, dx: f64, dy: f64, dz: f64, angle: f64, out_gen_faces: &mut Vec<u64>, out_gen_edges: &mut Vec<u64>) -> UniquePtr<TopoDS_Shape>;
