...
#[cfg(feature = "color")]
pub use traits::StepOccurrence;
pub use traits::{BSplineEnd, ProfileOrient, Surface, Tessellation};
...
impl Solid {
	...
	pub fn iter_edge_history(&self) -> impl Iterator<Item = [u64; 2]> + '_ {
		<Self as crate::traits::SolidStruct>::iter_edge_history(self)
	}
	...
	#[cfg(feature = "color")]
	pub fn read_step_assembly<R: std::io::Read>(reader: &mut R) -> Result<(Vec<String>, Vec<StepOccurrence<crate::Solid>>), Error> {
		<Self as crate::traits::SolidStruct>::read_step_assembly(reader)
	}
